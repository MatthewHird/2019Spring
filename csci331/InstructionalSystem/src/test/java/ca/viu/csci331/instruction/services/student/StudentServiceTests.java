...
public class StudentServiceTests {
    ...
    @Before
    public void prepareStudentService() {
        ...
        studentService = new StudentService(enrollmentList);
    }
    ...
    public void testGetAllEnrollments() {
        ...
        assertTrue(compareEnrollmentArrayList(expected, studentService.getAllEnrollments()));
    }
    
    @Test
    public void testEnroll() throws DuplicateEnrollmentException {
        Student stu1 = new Student("Student1", "stu1", "s1@mail.com");
        Student stu2 = new Student("Student2", "stu2", "s2@mail.com");
        Student stu3 = new Student("Student3", "stu3", "s3@mail.com");
        Student stu4 = new Student("Student4", "stu4", "s4@mail.com");
        ...
        expected.add(enr9);
        studentService.enroll(stu1, sem3);
        assertTrue(compareEnrollmentArrayList(expected, studentService.getAllEnrollments()));
    }
    
    @Test
    public void testWithdraw() throws EnrollmentNotFoundException {
        Student stu1 = new Student("Student1", "stu1", "s1@mail.com");
        Student stu2 = new Student("Student2", "stu2", "s2@mail.com");
        Student stu3 = new Student("Student3", "stu3", "s3@mail.com");
        Student stu4 = new Student("Student4", "stu4", "s4@mail.com");
        ...
        studentService.withdraw("stu3", "sem1");
        assertTrue(compareEnrollmentArrayList(expected, studentService.getAllEnrollments()));
    }
    
    @Test
    public void testGetEnrolledSeminarsByStudentId() {
        ...
        assertTrue(compareSeminarArrayList(expected, studentService.getEnrolledSeminarsByStudentId("stu1")));
    }
    
    @Test
    public void testGetCurrentTimeTableByStudentId() {
        String expected = "Current Time Table for Student with ID #stu3\n\n" 
                + "Course #: cou1  Seminar ID: sem1  Day: Monday  Start Time: 09:00  End Time: 10:00  Building: B001  Room: R001\n\n" 
                + "Course #: cou1  Seminar ID: sem1  Day: Tuesday  Start Time: 09:00  End Time: 10:00  Building: B001  Room: R001\n\n";
        
        assertEquals(expected, studentService.getCurrentTimeTableByStudentId("stu3"));
    }
    
    @Test
    public void testGetTranscriptOfCompletedByStudentId() {
        String expected = "Transcript of Completed Seminars for Student with ID #stu1\n\n" 
                + "Course #: cou2  Course Name: Course 2  Grade: 82.100000%  Credits: 3.000000\n\n" 
                + "Course #: cou3  Course Name: Course 3  Grade: 75.000000%  Credits: 3.000000\n\n";
        
        assertEquals(expected, studentService.getTranscriptOfCompletedByStudentId("stu1"));
    }
