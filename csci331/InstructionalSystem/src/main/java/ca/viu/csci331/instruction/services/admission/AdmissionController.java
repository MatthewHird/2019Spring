...
public class AdmissionController {
    ...
    private void menu() {
        ...
        while (!terminate) {
            ...
            String command = AdmissionInputHandler.getLineEntry().toLowerCase();
    ...
    public void admitNewStudent() {
        ...
        do {
            studentName = AdmissionInputHandler.getLineEntry();
        ...
        do {
            studentEmail = AdmissionInputHandler.getLineEntry();
    ...
    public void cancelExistingStudent() {
        ...
        String enteredStudentId = AdmissionInputHandler.getLineEntry();
    ...
    public void updateExistingStudent() {
        ...
        if (enteredStudentId.equals("0")) {
            ...
            invalidInput = true;
            do {
                command = AdmissionInputHandler.getLineEntry().toLowerCase();
                if (command.equals("y")) {
            ...
            do {
                ...
                if (command.equals("y")) {
                    ...
                    do {
                        admissionStatus = AdmissionInputHandler.getLineEntry();
            ...
            do {
                command = AdmissionInputHandler.getLineEntry().toLowerCase();
                if (command.equals("y")) {
                    int year = AdmissionInputHandler.getYearIntEntry(PROMPT3);
                    int month = AdmissionInputHandler.getMonthIntEntry(PROMPT3);
                    int day = AdmissionInputHandler.getDayIntEntry(PROMPT3, year, month);
